...
from diffusers import AutoencoderKL, DDIMScheduler, DDPMScheduler, UNet2DConditionModel,DPMSolverMultistepScheduler
...
class Stable_Diffusion(nn.Module):
    ...
    def __init__(self, pretrained_path, clip_skip=None, sd_version='v1', test_sampler_type='ddim'):
        ...
        elif test_sampler_type == 'dpm':
            self.test_scheduler = DPMSolverMultistepScheduler.from_pretrained(pretrained_path, subfolder='scheduler')
        else:
